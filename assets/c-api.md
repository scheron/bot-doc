...
- деление на 0, осуществляемое в целях числах (тип данных `int` и его модификации);
...
- израсходование памяти, выделенной приложению, в связи с тем, что пользователем осуществялется лишь бесконтрольное наполнение коллекций элементами и не продумана очистка коллекций.
