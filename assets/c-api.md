...
- Чтобы ограничить частоту записей в лог в целях отладки рекомендуется использовать [таймер](#timers) (перед запуском в бой можно удалить и сам таймер и вывод в лог)
