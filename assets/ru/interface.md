...
- **Sell/Buy** - значение расчётной цены на продажу/покупку (при использовании кликера поля остаются пустыми);
- **Lim_S/Lim_B** - значение сигнальной цены на продажу/покупку (при использовании кликера поля остаются пустыми);
