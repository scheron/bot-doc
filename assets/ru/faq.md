...
- <details>
   ...
   Основных причины две: удаление портфеля пользователем и удаление данных старше 6 месяцев. Если вы удалите портфель из робота, то связанные с ним сделки и логи  не будут отображаться в соответствующих виджетах. Хранение исторических данных по сделкам, финансовым результатам и логам осуществляется в течение 6 месяцев, более старые данные удаляются. Если портфель не удалён, торговля по нему осуществялалсь недавно, а никакая информация по данному портфелю в виджетах не обновляется - обратитесь в техническую поддержку, подробно описав ситуацию и прикрепив скриншоты проблемы и подробное описание.
