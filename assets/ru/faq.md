...
---    
- <details>
    <summary><i>Робот выставил заявку не по тем ценам, на которые был настроен портфель. Почему так могло произойти? Как исправить? <Anchor :ids="['faq.wrong_price']" /></i></summary>
