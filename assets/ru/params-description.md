...
Важно! Все выставления заявок в роботе используют отступ k или [k_sl](params-description.md#s.k_sl), кроме кликера Place order и режима Pos leveling виджета Trade connections positions. В этих двух случаях никакие отступы от указанной пользователем цены не используются.
