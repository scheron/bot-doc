...
Доступ к настройкам робота можно ограничить списком доверенных IP-адресов.
...
Если список пуст, то доступ разрешён всем. Если в списке присутствует хотя бы 1 ip-адрес, доступ разрешён только с него.
