...
section: 6
summary: 'Подключения к биржам и брокерам: поддерживаемые рынки и все параметры, задаваемые при создании подключения.'
---
...
### Транзакционный шлюз бинарного протокола <Anchor :ids="['tc.SPB.binary_protocol_gateway']" />
...
### Транзакционный шлюз бинарного протокола <Anchor :ids="['tc.IMEX.binary_protocol_gateway']" />
...
### Транзакционный шлюз бинарного протокола <Anchor :ids="['tc.ITS.binary_protocol_gateway']" />
...
### Транзакционный шлюз бинарного протокола <Anchor :ids="['tc.OREX.binary_protocol_gateway']" />
