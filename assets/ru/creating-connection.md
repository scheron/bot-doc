...
- <details>
   ...
   ![Alt text](@images/binance_1.png)
    ...
    Запустите приложение и выберите типа генерации ключа `Ed25519`.
    ...
    Скопируйте ключи и сохраните в надежном месте.
    ...
    Аналогично для `Secret` использовать среднюю часть из `PRIVATE KEY`
