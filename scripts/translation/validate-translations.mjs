 ...
 */
export function readGlossary(file = GLOSSARY_FILE) {
  if (!existsSync(file)) return { banned: [], verbatim: [] };
  ...
  const verbatim = [...section('Keep verbatim').matchAll(/`([^`]+)`/g)].map(match => match[1]);
